#Copyright ©️ 2021 CM TiPs. All Rights Reserved
#You are free to use this code in any of your project, but you MUST include the following in your README.md (Copy & paste)
# ##Credits - [Countdown Timer Telegram bot by CM TiPs] (https://t.me/Tips_by_CM)
...
async def callback_query(client: Client, query: CallbackQuery):
    if query.data=="HELP_CALLBACK":
        ...
        TELETIPS_GROUP_BUTTONS = [
            [
                InlineKeyboardButton("CM TiPs Chat [EN]", url="https://t.me/Tips_by_CM")
            ],
            [
                InlineKeyboardButton("⬅️ BACK", callback_data="START_CALLBACK"),
            ]
        ...
        TELETIPS_START_BUTTONS = [
            ...
            [
                ...
                InlineKeyboardButton('👨‍💻 CREATOR', url=https://t.me/Jaatbro23')
            ],
            [
                InlineKeyboardButton('➕ CREATE YOUR BOT ➕', callback_data="TUTORIAL_CALLBACK")
            ]
        ...
        if message.chat.id>0:
            ...
            if 0<user_input_time<=10:
                while user_input_time and not stoptimer:
                    ...
                    user_input_time -=1
                await finish_countdown.edit("🚨 Come On! Beep!! **TIME'S UP!!!**")
...
async def stop_timer(Client, message):
    ...
    try:
        if (await bot.get_chat_member(message.chat.id,message.from_user.id)).privileges:
            stoptimer = True
            await message.reply('🛑 CM TIME stopped.')
        else:
